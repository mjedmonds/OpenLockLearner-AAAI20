...
scenerios = ["CC3toCC4", "CE3toCC4", "CC3toCE4", "CE3toCE4"]
...
target_path = os.path.join(log_path, "all_transfer_log")
target_img_path = os.path.join(log_path, "all_transfer_log", "imgs")
