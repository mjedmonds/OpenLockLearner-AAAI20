...
from openlockagents.TRPO.trpo_agent import TRPOAgent
...
def main():
    ...
    # dummy agent
    agent = TRPOAgent(env, 1, 1, params, require_log=False)
    ...
    agent = TRPOAgent(env, state_size, action_size, params)
    load_path = (
