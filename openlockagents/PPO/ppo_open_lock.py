...
from openlockagents.PPO.ppo_agent import PPOAgent
...
def main():
    ...
    params["optim_epochs"] = 5
    params["optim_value_epochs"] = 1
    params["optim_batch_size"] = 512
    params["use_gpu"] = True
    ...
    # dummy agent
    agent = PPOAgent(env, 1, 1, params, require_log=False)
    ...
    agent = PPOAgent(env, state_size, action_size, params)
    load_path = (
